...
const CreatePostPage = () => {
    ...
    const [location, setLocation] = useState(''); // ✅ Badlav: Ab location ek string hai
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('location', location); // ✅ Badlav: Ab ek hi location bhejein
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <form onSubmit={handleSubmit} className="p-4">
                ...
                {/* ✅ Badlav: Ab sirf ek Location Input Box hai */}
