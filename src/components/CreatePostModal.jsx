...
import API_BASE_URL from '../pages/apiConfig'; // API URL import karein
...
const CreatePostModal = ({ user, onClose, onPostSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onPostSuccess(response.data); // Naya post feed me add karein
